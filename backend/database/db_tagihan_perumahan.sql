...
CREATE TABLE `invoice` (
  ...
  `periode_bayar` varchar(50) DEFAULT NULL,
  `total_bayar` decimal(10,2) DEFAULT NULL,
  `status` varchar(20) DEFAULT 'Unpaid',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id_invoice`),
  KEY `id_tagihan` (`id_tagihan`),
  CONSTRAINT `invoice_ibfk_1` FOREIGN KEY (`id_tagihan`) REFERENCES `tagihan` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(5,'Gaji Satpam Shift 1','Gaji',3500000.00,'2026-01-14','2026-01-14 23:34:34');
...
(12,'Adil',NULL,NULL,'Penghuni','082252521231'),
(13,'Adib',NULL,NULL,'Penghuni','0852145123'),
(14,'Luthfi',NULL,NULL,'Penghuni','081321331231'),
(18,'Botan',NULL,'123','Penghuni','08761213113'),
(19,'Arifian',NULL,'123','Penghuni','082386986705');
...
(14,21,18,'Tetap',1,'0000-00-00',NULL),
(15,30,19,'Tetap',1,'0000-00-00',NULL);
...
(26,'Januari','2026-01-01','2026-01-31',NULL,1),
(27,'Februari','2026-02-01','2026-02-28',NULL,1);
...
CREATE TABLE `tagihan` (
  ...
  `jumlah_terbayar` decimal(10,2) DEFAULT NULL,
...
insert  into `tagihan`(`id`,`id_periode`,`jumlah`,`id_rumah`,`id_kategori`,`status`,`jumlah_terbayar`,`nomor_va`,`jatuh_tempo`,`created_at`) values 
(15,26,2500000.00,16,1,'Lunas',2500000.00,'88002026010016','2026-02-10','2026-01-12 21:00:37'),
(16,26,2500000.00,17,1,'Lunas',2500000.00,'88002026010017','2026-02-10','2026-01-12 21:00:37'),
(17,26,2500000.00,18,1,'Lunas',2500000.00,'88002026010018','2026-02-10','2026-01-12 21:00:37'),
(18,26,2500000.00,19,1,'Belum Bayar',0.00,'88002026010019','2026-02-10','2026-01-12 21:00:37'),
(19,26,2500000.00,21,1,'Lunas',2500000.00,'88002026010021','2026-02-10','2026-01-12 21:00:37'),
(22,27,2500000.00,16,1,'Lunas',2500000.00,'88002026020016','2026-03-10','2026-01-12 21:04:51'),
(23,27,2500000.00,17,1,'Lunas',2500000.00,'88002026020017','2026-03-10','2026-01-12 21:04:51'),
(24,27,2500000.00,18,1,'Belum Bayar',0.00,'88002026020018','2026-03-10','2026-01-12 21:04:51'),
(25,27,2500000.00,19,1,'Belum Bayar',0.00,'88002026020019','2026-03-10','2026-01-12 21:04:51'),
(26,27,2500000.00,21,1,'Belum Bayar',0.00,'88002026020021','2026-03-10','2026-01-12 21:04:51'),
(29,26,2500000.00,30,1,'Lunas',2500000.00,'88002026010030','2026-02-10','2026-01-17 21:10:49');
...
/* Trigger structure for table `penghuni_rumah` */

DELIMITER $$

/*!50003 DROP TRIGGER*//*!50032 IF EXISTS */ /*!50003 `reset_status_rumah_setelah_hapus` */$$

/*!50003 CREATE */ /*!50003 TRIGGER `reset_status_rumah_setelah_hapus` AFTER DELETE ON `penghuni_rumah` FOR EACH ROW BEGIN
    -- Update status rumah menjadi Kosong jika penghuni dihapus
    UPDATE rumah SET status = 'Kosong' WHERE id = OLD.id_rumah;
END */$$
...
/*!50003 DROP TRIGGER*//*!50032 IF EXISTS */ /*!50003 `reset_status_rumah_otomatis` */$$

/*!50003 CREATE */ /*!50003 TRIGGER `reset_status_rumah_otomatis` AFTER DELETE ON `penghuni_rumah` FOR EACH ROW BEGIN
    -- Saat record di penghuni_rumah dihapus, rumah tersebut otomatis jadi Kosong
    UPDATE rumah SET status = 'Kosong' WHERE id = OLD.id_rumah;
END */$$
